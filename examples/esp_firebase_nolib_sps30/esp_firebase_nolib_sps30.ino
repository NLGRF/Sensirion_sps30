...
void loop() {
  ...
  while (1) {
    ...
    ESP32_Set_Firebase("Sensor/MC1p0", String(measurement.mc_1p0, DEC));
      ESP32_Set_Firebase("Sensor/MC2p5", String(measurement.mc_2p5, DEC));
      ESP32_Set_Firebase("Sensor/MC4p0", String(measurement.mc_4p0, DEC));
      ESP32_Set_Firebase("Sensor/MC10p0", String(measurement.mc_10p0, DEC));
    ESP32_Set_Firebase("Sensor/NC1p0", String(measurement.nc_1p0, DEC));
      ESP32_Set_Firebase("Sensor/NC2p5", String(measurement.nc_2p5, DEC));
      ESP32_Set_Firebase("Sensor/NC4p0", String(measurement.nc_4p0, DEC));
      ESP32_Set_Firebase("Sensor/NC10p0", String(measurement.nc_10p0, DEC));
    ESP32_Set_Firebase("Sensor/TPS", String(measurement.typical_particle_size, DEC));

    Serial.println("Send Successful!");
    
    /*
    Serial.println(ESP32_Get_Firebase("Sensor/?"));
    Serial.printf("?\n", ?);
    */
